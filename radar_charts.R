...
Here's the example (with minor adjustments) provided on John Coene's [ECharts4R site](https://echarts4r.john-coene.com/articles/chart_types). It depicts two series, `y` and `z`, mapped to five variables (A-E). The chart has a tooltip and a `piecewise` legend that allows you to toggle visibility for the series.  
